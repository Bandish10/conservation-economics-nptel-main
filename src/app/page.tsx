      ...
      <div className="max-w-5xl w-full relative z-10">
        <div className="mb-16 flex flex-col md:flex-row items-center justify-between">
          <div className="text-left mb-8 md:mb-0">
            <h1 className="text-6xl font-bold mb-2 tracking-tighter font-sans">
              NPTEL
            </h1>
            <h2 className="text-2xl font-light">Conservation Economics</h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <FeatureCard
            ...
            description="In-depth questions covering all aspects of the NPTEL Conservation Economics course"
          />
          <FeatureCard
            icon={TreePine}
